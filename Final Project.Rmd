...
author: "Paul Marino, Austin Sechrest"
date: "5/2/2019"
output: pdf_document
---
...
```{r}
plot(amidata$CHARGES, amidata$LOS)
plot(amidata$CHARGES, amidata$AGE)
```

```{r}
library(gam)
glm_model = glm(CHARGES ~ AGE + DIAGNOSIS + SEX + DRG + DIED + LOS, data = amidata)
summary(glm_model)
```
